...
const AdminLoginPage = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-700 via-gray-800 to-black py-6 sm:py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-6 sm:space-y-8 bg-white p-6 sm:p-10 rounded-xl shadow-2xl">
          ...
          <form className="mt-6 sm:mt-8 space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
            ...
            />
            <div className="pt-2">
              <Button type="submit" className="w-full text-base sm:text-lg py-2 sm:py-3" disabled={loading}>
          ...
          <div className="text-center mt-4">
            <p className="text-sm text-gray-500">
              Portail d'administration des sondages repas
            </p>
          </div>
        </div>
      </div>
